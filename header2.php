    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        ...
        <li class="nav-item"><a href="index.html" class="nav-link">Home</a></li>
	        	...
	        	<li class="nav-item active"><a href="project.php" class="nav-link">Data dan Informasi</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end">
          <div class="col-md-9 ftco-animate pb-1">
			...
			<span>Data <i class="ion-ios-arrow-forward"></i></span></p>
            <h1 class="mb-0 bread">Data Hotel </h1>
          </div>
        </div>
      </div>
    </section>
